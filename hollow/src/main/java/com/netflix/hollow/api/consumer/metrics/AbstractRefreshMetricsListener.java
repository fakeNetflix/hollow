...
public abstract class AbstractRefreshMetricsListener extends AbstractRefreshListener implements RefreshMetricsReporting {
     ...
     * in the implementation then an exception there can fail the consumer refresh. This method protects against that by
     * catching all exceptions, logging that there was an exception, and continuing with the consumer refresh.
    ...
    private final void noFailRefreshEndMetricsReporting(ConsumerRefreshMetrics refreshMetrics) {
        try {
            ...
            // Metric reporting is not considered critical to consumer refresh. Swallow any exceptions and continue.
